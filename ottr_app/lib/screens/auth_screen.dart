...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
        ...
        if (currentUser != null && mounted) {
          ...
          try {
            ...
            if (userDoc.exists && userDoc.data()?['username'] != null) {
              // User has a username, navigate to connect screen
            ...
            // Continue with default navigation to username screen
          }
        }
      } else {
        // Register
      ...
      // If we get here, authentication was successful but username might not be set
      if (mounted) {
        Navigator.of(context).pushReplacement(
